		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Lists",
									"targetURL": "#logaligroupapplists-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupapplists-display": {
								"semanticObject": "logaligroupapplists",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.applists",
									"url": sap.ui.require.toUrl("logaligroup/applists")
								}
							}
						}
					}
